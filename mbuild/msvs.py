...
def _set_msvs_dev18(env, x64_host, x64_target, regv=None): # msvs 2026
    ...
    add_env(path, '{}/Common7/IDE/VC/VCPackages'.format(vprefix))
    add_env(path, '{}/Common7/IDE/CommonExtensions/Microsoft/TestWindow'.format(vprefix))
    add_env(path, '{}/Common7/IDE/CommonExtensions/Microsoft/TeamFoundation/Team Explorer'.format(vprefix))
    add_env(path, '{}/MsBuild/Current/Bin/Roslyn'.format(vprefix))
    add_env(path, '{}/Team Tools/Performance Tools'.format(vprefix))
    
    add_env(path, progfi + '/Microsoft Visual Studio/Shared/Common/VSPerfCollectionTools/vs2026')
    ...
    set_env('VisualStudioVersion', '18.0')
...
def _figure_out_msvs_version_filesystem(env, specific_version=0):
    ...
    prefixes = [
        (18,'C:/Program Files/Microsoft Visual Studio/2026'),
